package com.gfs.gordonnow.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.gfs.gordonnow.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.gfs.gordonnow.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
