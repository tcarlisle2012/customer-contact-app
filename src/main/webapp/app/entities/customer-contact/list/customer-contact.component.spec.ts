...
describe('CustomerContact Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'customer-contact', component: CustomerContactComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.customerContacts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to customerContactService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCustomerContactIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCustomerContactIdentifier).toHaveBeenCalledWith(entity);
